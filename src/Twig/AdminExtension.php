...
class AdminExtension extends \Twig_Extension
{
     ...
     */
    public function __construct(AdminManager $adminManager, RoutingHelper $routingHelper, TranslatorInterface $translator = null)
    {
    ...
    public function getAdminLabel(AdminInterface $admin, $plural = false)
    {
        ...
        return $this->translator->transChoice($admin->getLabel(), $count);
    }
